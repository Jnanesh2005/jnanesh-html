...
function PizzaCreate() {
    const [pizza, setPizza] = useState({ id: '', number: '', model: '', type: '', price: '' });
    ...
    return (
        <>
            <PageHeader />
            <h3><a href="/pizzas/list" className="btn btn-light">Go Back</a><h1 className="text-center"><em> Add Pizza </em></h1></h3>
            ...
            <div className="container">
                ...
                <div className="form-group mb-3">
                    ...
                    <input type="text" className="form-control" id="price"
                        placeholder="please enter pizza price"
                        value={pizza.price}
                        onChange={txtBoxOnChange} />
                </div>
